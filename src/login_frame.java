...
public class login_frame extends javax.swing.JFrame {
    ...
    Connection con; // Deklarasi dgn variable package yang sudah diimport. 
    Statement stat; 
    ResultSet rs; 
    String sql;
    ...
    public login_frame() {
        initComponents();
        koneksi DB = new koneksi(); // hubungkan dengan koneksi.java yang sudah dibuat pada tahap 2. 
        DB.config(); 
        con = DB.con; 
        stat = DB.stm;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            sql = "SELECT * FROM tblogin WHERE username='"+jTextField1.getText()+"' AND password='"+jPasswordField1.getText()+"'"; // Query Mysql harus benar sesuai nama tabel pada database
            rs = stat.executeQuery(sql);
            
            if(rs.next()){
                if(jTextField1.getText().equals(rs.getString("username")) && jPasswordField1.getText().equals(rs.getString("password"))){
                    this.setVisible(false);
                    new Home().setVisible(true); // Akan link ke halaman / jframe home
                }
            }else{
